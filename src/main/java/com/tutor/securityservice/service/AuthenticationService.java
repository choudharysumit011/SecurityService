...
import com.tutor.securityservice.dto.UserLoginDto;
import com.tutor.securityservice.dto.UserRegisterDto;
import com.tutor.securityservice.dto.UserVerifyDto;
...
public class AuthenticationService {
    ...
    public User signup(UserRegisterDto input) {
        if (input.getEmail() == null || input.getEmail().isEmpty()) {
            throw new IllegalArgumentException("Email is empty from request cannot be empty");
        }
